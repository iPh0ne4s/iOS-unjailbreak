...
### 9.2-9.3.5_normal.sh
- `9.2-9.3.5_normal.sh` is supposed to be executed in normal mode
...
- Copy `9.2-9.3.5_normal.sh` to device, in my case it is copied to /private/var/tmp, set 777 permission
...
### 9.2-9.3.5_ramdisk.sh
- `9.2-9.3.5_ramdisk.sh` is supposed to be executed in SSH ramdisk mode
...
- Copy `9.2-9.3.5_ramdisk.sh` to device, in my case it is copied to /mnt1, set 777 permission
