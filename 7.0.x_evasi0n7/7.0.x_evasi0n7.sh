...
if [ -e /private/var/stash/Applications* ] || [ -e /private/var/stash/*/Applications ]; then
    rm -rf /Applications; mv /private/var/stash/Applications* /Applications || mv /private/var/stash/*/Applications /
fi
