## Usage
- `7.0-7.1.2.sh` is supposed to be executed in normal mode
...
- Replace `/System/Library/Lockdown/Services.plist` with the file in `Services.plist` folder
- Copy `7.0-7.1.2.sh` to device, in my case it is copied to /private/var/tmp, set 777 permission
