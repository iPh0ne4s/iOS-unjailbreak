...
### 8.0-8.4.1_wtfis_normal.sh
- `8.0-8.4.1_wtfis_normal.sh` is supposed to be executed in normal mode
...
- Replace `/usr/libexec/installd` and `/usr/libexec/lsd` respectively with `installd` and `lsd` in 8.x/installd and 8.x/lsd folders, set 0755 permission for both
- Copy `8.0-8.4.1_wtfis_normal.sh` to device, in my case it is copied to /private/var/tmp, set 777 permission
...
### 8.0-8.4.1_wtfis_ramdisk.sh
- `8.0-8.4.1_wtfis_ramdisk.sh` is supposed to be executed in SSH ramdisk mode
...
- Replace `/mnt1/usr/libexec/installd` and `/mnt1/usr/libexec/lsd` respectively with `installd` and `lsd` in 8.x/installd and 8.x/lsd folders, set 0755 permission for both
- Copy `8.0-8.4.1_wtfis_ramdisk.sh` to device, in my case it is copied to /mnt1, set 777 permission
