## Usage
- `8.0-8.1.2_PPJailbreak.sh` is supposed to be executed in normal mode
...
- Copy `8.0-8.1.2_PPJailbreak.sh` to device, in my case it is copied to /private/var/tmp, set 777 permission
